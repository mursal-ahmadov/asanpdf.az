  ...
  return (
    <>
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="xl:hidden inline-flex items-center justify-center w-10 h-10 rounded-lg text-foreground hover:bg-gray-100 active:bg-gray-200 cursor-pointer touch-manipulation"
      ...
      {open && (
        <>
          {/* Backdrop */}
          <div
            className="xl:hidden fixed left-0 right-0 bottom-0 bg-black/40 z-40"
            style={{ top: "80px" }}
          ...
          <nav
            className="xl:hidden fixed left-0 right-0 bg-white border-b border-border shadow-lg z-50"
            style={{ top: "80px" }}
          >
